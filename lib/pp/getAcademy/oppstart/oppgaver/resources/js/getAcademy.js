...
function htmlManipulation(arg, width, color)
{
    ...
    <div class='fvtie'>
        <p>
        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam tempus maximus rhoncus.
    ...
    //  manipulate width
    document.querySelector('.fvtie').style.inlineSize = '10px';
    // manipulate if/else
    document.querySelector('.fvtie').style.backGroundColor= 'red';
}
