...
function prevImg()
{
    ...
    {
        head.alt = 'head4.png';
        head.src = 'resources/img/head4.png';
    }
    else if (head.src.endsWith('head4.png'))
    {
        head.alt = 'head3.png';
        head.src = 'resources/img/head3.png';
    }
    else if (head.src.endsWith('head3.png'))
    {
        head.alt = 'head2.png';
        head.src = 'resources/img/head2.png';
    }
    else if (head.src.endsWith('head2.png'))
    {
        head.alt = 'head1.png';
        head.src = 'resources/img/head1.png';
    }
    ...
    if (body.src.endsWith('body1.png'))
        {
            body.alt = 'body4.png';
            body.src = 'resources/img/body4.png';
        }
        else if (body.src.endsWith('body4.png'))
        {
            body.alt = 'body3.png';
            body.src = 'resources/img/body3.png';
        }
        else if (body.src.endsWith('body3.png'))
        {
            body.alt = 'body2.png';
            body.src = 'resources/img/body2.png';
        }
        else if (body.src.endsWith('body2.png'))
        {
            body.alt = 'body1.png';
            body.src = 'resources/img/body1.png';
        }
    //  Ensure the src attribute for legs
    if (legs.src.endsWith('legs1.png'))
        {
            legs.alt = 'legs4.png';
            legs.src = 'resources/img/legs4.png';
        }
        else if (legs.src.endsWith('legs4.png'))
        {
            legs.alt = 'legs3.png';
            legs.src = 'resources/img/legs3.png';
        }
        else if (legs.src.endsWith('legs3.png'))
        {
            legs.alt = 'legs2.png';
            legs.src = 'resources/img/legs2.png';
        }
        else if (legs.src.endsWith('legs2.png'))
        {
            legs.alt = 'legs1.png';
            legs.src = 'resources/img/legs1.png';
        }
